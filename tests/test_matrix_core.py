...
def test_tool_contract_registry_records_standalone_sections_and_future_names():
    ...
    assert contracts["link"].display_name == "LINK"
...
def test_diagonalizer_auto_avoids_gpu_probe_for_small_matrices(monkeypatch):
    from matrix_core import diagonalizer
    ...
    monkeypatch.delenv("MATRIX_DIAGONALIZER_BACKEND", raising=False)
    monkeypatch.setenv("MATRIX_DIAGONALIZER_GPU_MIN_SIZE", "128")

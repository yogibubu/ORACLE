...
The ORACLE copy intentionally includes code, documentation and runnable
...
```bash
python engines/puckering_dvr/scripts/mw_path_dvr.py \
...
```bash
python engines/puckering_dvr/scripts/fortran_bridge/run_fortran_dvr.py \
...
For the ORACLE ring-GIC path, Gaussian uses inactive `RPck....` coordinates

...
ORACLE note: this is the vendored runtime copy used by ORACLE. See
`README_ORACLE.md` for the GUI/Advanced workflow and environment commands.
...
ORACLE, use the GUI Advanced puckering workflow or
`oracle pucker-gaussian`; then pass the completed Gaussian log to this DVR
...
coordinate builders. Gaussian input generation belongs to ORACLE/`oracle`;

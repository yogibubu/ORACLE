...
\texttt{\detokenize{*_large_amplitude_coordinates.csv}} & Large-amplitude GIC
selection with family labels. \\
\texttt{\detokenize{*_large_amplitude_blocks.csv}} & Mono- and
...
criterion. \\
\texttt{\detokenize{*_large_amplitude_mode_ped.csv}} & Total large-amplitude

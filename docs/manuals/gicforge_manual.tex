...
\large Non-redundant generalized internal coordinates and symmetry-adapted coordinate bases in ORACLE}
...
\begin{abstract}
\program{} is the \oracle{} geometry backend that converts Cartesian molecular

...
against each other by analytic B-matrix rank.  Only after that protected pass
does it use ordinary primitives to complete the vibrational rank.  A special
coordinate may be skipped only when its own row is singular or linearly
...
\texttt{SPECIAL\_PROTECTED}.  The header also records the reduction policy
\texttt{SPECIAL\_PROTECTED\_FIRST\_THEN\_ORDINARY\_}
